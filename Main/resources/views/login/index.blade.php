...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div class="row g-0 bg-white min-vh-100 align-items-center">
        ...
        <div class="px-3 py-6">
          ...
          <div class="row">
            <div class="col-sm-8 col-md-6 col-lg-9 col-xl-12 mx-auto max-w-450">
              ...
              <h1 class="fw-bold mb-5">SPORT-B 登入</h1>

              <form novalidate class="bs-validate" method="POST" action="/login">
                @csrf 
                <!-- email address -->
                <div class="form-floating mb-3">
                  <input required type="text" class="form-control" id="account" name="account" placeholder="帳號">
                  <label for="account_email">帳號</label>
                </div>

                <!-- password -->
                <div class="form-floating mb-3">
                  <input required type="password" class="form-control" id="passwd" name="passwd" placeholder="密碼" autocomplete="new-password">
                  <label for="account_passwd">密碼</label>

                  <!-- forgot -->
                  <a href="" class="btn bg-transparent shadow-none link-muted position-absolute top-0 end-0 m-1">
                    忘記密碼?
                  </a>
                </div>
      ...
      <div class="d-none d-lg-block min-vh-100 col-lg-6 bg-cover py-8 overlay-dark overlay-opacity-25" style="background-image:url({{ asset('html_frontend/demo.files/images/unsplash/team/product-school-XZkk5xT8Xrk-unsplash.jpg') }})">
