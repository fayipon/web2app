				...
				<div class="container mt-5">
					...
					<div class="row w-100 d-middle">
						...
						<div class="col-12 col-lg-6 text-xs-center">
							...
							<p>
                            Presenting H5 pages as native apps on the user's desktop
							</p>


							<a href="/login" class="btn btn-lg btn-warning bg-gradient-warning transition-hover-top shadow-none mt-5">
								<span class="font-weight-medium">进入后台</span> 
							</a>
