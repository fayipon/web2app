...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="header-sticky header-over">
		...
		<div id="wrapper">
						...
						<div class="collapse navbar-collapse navbar-animate-fadein justify-content-end" id="navbarMainNav">
							...
							<ul class="navbar-nav fs--14">
								...
								<li class="nav-item">
									...
									<a class="nav-link scroll-to" href="#wrapper">
										HOME
									</a>
								...
								<li class="nav-item">
									...
									<a class="nav-link scroll-to" href="#section_features">
										FEATURES
									</a>
			...
			<section class="min-h-75vh bg-gradient-indigo text-white">
					...
					<div class="row w-100 d-middle">
						...
						<div class="col-12 col-lg-6 text-xs-center">
							...
							<h1 class="mb-3">
								...
								<span class="d-block h2 h4-xs mb-0 font-weight-light">
									Amazing employees deserve
								</span>

								<span class="d-block h3-xs mb-0 font-weight-light">
									amazing software
								</span>
							...
							<p>
								The simplest way to work together in the cloud! <br>
								Start in one step now, no credit card required.
							</p>


							<a href="#!" class="btn btn-lg btn-warning bg-gradient-warning transition-hover-top shadow-none mt-5">
								<span class="font-weight-medium">Start Now</span> &ndash; It's Free
							</a>
			            ...
			            <div class="col-12 col-lg-6 text-center">
							...
							<img class="w-100" src="demo.files/svg/premium/using_product.svg" alt="...">
					...
					<div class="py-6" data-aos="fade-in" data-aos-delay="0" data-aos-offset="0">
						...
						<div class="row">
							<div class="col-12 col-lg-6 mb-5">
								...
								<!-- slogan -->
								<p class="lead mb-0 max-w-450">
									The simplest way to work together in the cloud! Start in one step now, no credit card required.
								</p>

								<form novalidate class="bs-validate d-block clearfix py-5" method="post" action="#">

									<div class="max-w-300 mb-3">
										<input required="" type="email" class="form-control form-control-clean bg-transparent" placeholder="Email address">
									</div>

									<button type="submit" class="btn btn-success transition-hover-top bg-gradient-success b-0 d-block-xs">
										TRY FOR FREE
									</button>
							...
							<div class="col-12 col-lg-6 mb-5">
								...
								<!-- brands -->
								<div class="bg-white overflow-hidden shadow-primary-xs">
									<div class="row rounded row-grid b-0 text-center mb--n1">

										<div class="col-6 col-md-4 py-5" data-aos="fade-in" data-aos-delay="150" data-aos-offset="0">
											<img width="140" height="50" class="img-fluid opacity-4" src="demo.files/svg/vendors/vendor_airbnb.svg" alt="...">
										</div>

										<div class="col-6 col-md-4 py-5" data-aos="fade-in" data-aos-delay="200" data-aos-offset="0">
											<img width="140" height="50" class="img-fluid opacity-4" src="demo.files/svg/vendors/vendor_netflix.svg" alt="...">
										</div>

										<div class="col-6 col-md-4 py-5" data-aos="fade-in" data-aos-delay="250" data-aos-offset="0">
											<img width="140" height="50" class="img-fluid opacity-4" src="demo.files/svg/vendors/vendor_coinbase.svg" alt="...">
										</div>

										<div class="col-6 col-md-4 py-5" data-aos="fade-in" data-aos-delay="300" data-aos-offset="0">
											<img width="140" height="50" class="img-fluid opacity-4" src="demo.files/svg/vendors/vendor_instagram.svg" alt="...">
										</div>

										<div class="col-6 col-md-4 py-5" data-aos="fade-in" data-aos-delay="350" data-aos-offset="0">
											<img width="140" height="50" class="img-fluid opacity-4" src="demo.files/svg/vendors/vendor_pinterest.svg" alt="...">
										</div>

										<div class="col-6 col-md-4 py-5" data-aos="fade-in" data-aos-delay="400" data-aos-offset="0">
											<img width="140" height="50" class="img-fluid opacity-4" src="demo.files/svg/vendors/vendor_dribble.svg" alt="...">
										</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-6 col-md-4 mb-5">
							...
							<!-- icon -->
							<div class="w--80 h--80 rounded-circle bg-gradient-primary d-inline-flex align-items-center justify-content-center">
								<svg width="45" fill="#ffffff" viewBox="0 0 486.742 486.742"><path d="M33 362.371v78.9c0 4.8 3.9 8.8 8.8 8.8h61c4.8 0 8.8-3.9 8.8-8.8v-138.8l-44.3 44.3c-9.4 9.3-21.4 14.7-34.3 15.6zM142 301.471v139.8c0 4.8 3.9 8.8 8.8 8.8h61c4.8 0 8.8-3.9 8.8-8.8v-82.3c-13.9-.3-26.9-5.8-36.7-15.6l-41.9-41.9zM251 350.271v91c0 4.8 3.9 8.8 8.8 8.8h61c4.8 0 8.8-3.9 8.8-8.8v-167.9l-69.9 69.9c-2.7 2.7-5.6 5-8.7 7zM432.7 170.171l-72.7 72.7v198.4c0 4.8 3.9 8.8 8.8 8.8h61c4.8 0 8.8-3.9 8.8-8.8v-265.6c-2-1.7-3.5-3.2-4.6-4.2l-1.3-1.3zM482.6 41.371c-2.9-3.1-7.3-4.7-12.9-4.7h-1.6l-85.1 4c-3.8.2-9 .4-13.1 4.5-1.3 1.3-2.3 2.8-3.1 4.6-4.2 9.1 1.7 15 4.5 17.8l7.1 7.2c4.9 5 9.9 10 14.9 14.9l-171.6 171.7-77.1-77.1c-4.6-4.6-10.8-7.2-17.4-7.2-6.6 0-12.7 2.6-17.3 7.2l-102.7 102.6c-9.6 9.6-9.6 25.1 0 34.7l4.6 4.6c4.6 4.6 10.8 7.2 17.4 7.2s12.7-2.6 17.3-7.2l80.7-80.7 77.1 77.1c4.6 4.6 10.8 7.2 17.4 7.2 6.6 0 12.7-2.6 17.4-7.2l193.6-193.6 21.9 21.8c2.6 2.6 6.2 6.2 11.7 6.2 2.3 0 4.6-.6 7-1.9 1.6-.9 3-1.9 4.2-3.1 4.3-4.3 5.1-9.8 5.3-14.1.8-18.4 1.7-36.8 2.6-55.3l1.3-27.7c.3-5.8-1-10.3-4.1-13.5z"/></svg>
							</div>

							<h2 class="h4 my-3">Instant Insights</h2>
							<p>Answering those questions and more is a tall order, but one you should approach with enthusiasm.</p>
						...
						<div class="col-12 col-md-4 mb-5 text-center-xs">
							...
							<!-- icon -->
							<div class="w--80 h--80 rounded-circle bg-gradient-primary d-inline-flex align-items-center justify-content-center">
								<svg width="45" fill="#ffffff" viewBox="0 0 512 512"><path d="M256 0c-49.629 0-90 41.371-90 91s40.371 90 90 90 90-40.371 90-90-40.371-91-90-91zM286 181h-60c-21.158 0-41.603 5.469-60.19 14.773 31.569 8.518 61.293 20.786 90.19 37.372 28.898-16.586 58.621-28.854 90.19-37.372-18.587-9.304-39.032-14.773-60.19-14.773zM482 271c-16.569 0-30 13.431-30 30v60c0 16.567 13.431 30 30 30 16.569 0 30-13.433 30-30v-60c0-16.569-13.431-30-30-30zM30 271c-16.569 0-30 13.431-30 30v60c0 16.567 13.431 30 30 30 16.569 0 30-13.433 30-30v-60c0-16.569-13.431-30-30-30zM45 211c-8.291 0-15 6.709-15 15v15c33.091 0 60 26.909 60 60v60c0 33.091-26.909 60-60 60v15c0 8.291 6.709 15 15 15 76.901 0 138.39 24.286 196 61v-252.406c-57.87-33.18-120.097-48.594-196-48.594zM482 241v-15c0-8.291-6.709-15-15-15-75.903 0-138.13 15.414-196 48.594v252.406c57.61-36.714 119.099-61 196-61 8.291 0 15-6.709 15-15v-15c-33.091 0-60-26.909-60-60v-60c0-33.091 26.909-60 60-60z"/></svg>
							</div>

							<h2 class="h4 my-3">Intelligent Learning</h2>
							<p>Answering those questions and more is a tall order, but one you should approach with enthusiasm.</p>
			...
			<!-- block : features -->
			<section id="section_features" class="border-top">
				<div class="container">

					<h2 class="h1 mb-4 text-center mb-7">
						Features
					</h2>
					...
					<div class="row">
						...
						<div class="col-6 col-md-4 mb-5">
							...
							<h3 class="h4 my-3">Netowking for Success</h3>
							<p>Answering those questions and <a href="#!">more is</a> a tall order, but one you should approach with enthusiasm.</p>
						
						</div>

						<div class="col-6 col-md-4 mb-5">

							<h3 class="h4 my-3">Instant Insights</h3>
							<p>Answering those questions and more is a tall order, but one you should approach with enthusiasm.</p>
						...
						<div class="col-6 col-md-4 mb-5">
							...
							<h3 class="h4 my-3">Intelligent Learning</h3>
							<p>Answering <a href="#!">those questions</a> and more is a tall order, but one you should approach with enthusiasm.</p>
						...
						<div class="col-6 col-md-4 mb-5">
							...
							<h3 class="h4 my-3">Superhero Teamwork</h3>
							<p>Answering those questions and more is a tall order, but one you should approach with enthusiasm.</p>
						...
						<div class="col-6 col-md-4 mb-5">
							...
							<h3 class="h4 my-3">AI Productivity Boost</h3>
							<p>Answering those questions and more is a tall order, but one you should approach <a href="#!">with enthusiasm</a>.</p>
						
						</div>

						<div class="col-6 col-md-4 mb-5">

							<h3 class="h4 my-3">Integrated APIs</h3>
							<p>Answering those questions and more is a tall order, but one you should approach with enthusiasm.</p>
			...
			<!-- block : pricing -->
			<section id="section_pricing" class="border-top">
				<div class="container">
					...
					<div class="border rounded px-5 p-4-xs">
						...
						<div class="row d-lg-flex align-items-lg-center">
							...
							<div class="col-12 col-lg-6 my-5">
								...
								<div class="d-flex justify-content-center">
									...
									<div class="display-2 font-weight-normal text-primary">
										<sup class="fs--30 px-2">$</sup>5 
									</div>

									<h4 class="fs--15 text-dark pt-5">
										<span class="d-block">per active user</span>
										<span class="d-block">/month</span>
									</h4>

								</div>

								<div class="d-block text-muted text-center">
								...
								<div class="text-center mt-5">
									...
									<a href="#!" class="mt-2 btn btn-success transition-hover-top bg-gradient-success b-0 d-block-xs">
										Try for Free
									</a>

									<a href="#section_contact" class="scroll-to mt-2 btn btn-secondary btn-soft transition-hover-top d-block-xs">
										Contact Us
									</a>
							...
							<div class="col-12 col-lg-6 my-5">
								...
								<div class="d-flex align-items-center mb-3">
									...
									<div class="w--40 h--40 badge badge-success badge-soft badge-ico-sm rounded-circle float-start">
										<i class="fi fi-check fs--20"></i>
									</div>

									<p class="text-dark font-weight-light mb-0 px-2">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-10 mx-auto col-lg-4 py-4">
							...
							<form novalidate="" method="post" action="#subscribe_url" class="bs-validate py-3 mt-1 input-group-over"> 
					...
					<div class="row">
						...
						<div class="col-12 col-lg-6 mb-5">
							...
							<h2 class="font-weight-light mb-5">
								<span class="font-weight-medium">Smarty</span> Contact!
							...
							<div class="row">
								<div class="col-12 col-lg-6">
									...
									<ul class="mt-4 mb-0 list-unstyled p-0 block-xs"> 
										...
										<li><a href="page-cookie.html">GDPR &amp; Cookies</a></li> 
									</ul>
								...
								<ul class="list-unstyled m-0">
									...
									<li class="list-item py-2">
										...
										<a href="tel:+01-555-5555" class="clearfix py-1 h3 mb-0 d-inline-block font-weight-medium text-info">
											<i class="float-start fi fi-phone h4"></i> 785-388-9450
										</a>
									...
									<li class="list-item py-2">
										...
										<a href="mailto:info@mycomany.com" class="clearfix py-1 h5 d-inline-block font-weight-medium text-warning">
											<i class="float-start fi fi-envelope h4 mt--n5"></i> info@mycomany.com
										</a>
